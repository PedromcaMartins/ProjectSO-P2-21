...
tests/client_server_simple_test: tests/client_server_simple_test.o client/tecnicofs_client_api.o common/pipe_control_functions.o fs/session.o
fs/tfs_server: fs/operations.o fs/state.o common/pipe_control_functions.o fs/session.o
tests/lib_destroy_after_all_closed_test: fs/operations.o fs/state.o common/pipe_control_functions.o fs/session.o
tests/simple_client: tests/simple_client.o client/tecnicofs_client_api.o common/pipe_control_functions.o fs/session.o
